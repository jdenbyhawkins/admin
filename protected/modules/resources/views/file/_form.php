...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model,'type',Lookup::items('FileType')); ?>
	...
	<div class="row">
		<?php echo $form->labelEx($model,'file_author'); ?>
		<?php echo $form->textField($model,'file_author',array('size'=>60,'maxlength'=>128)); ?>
		<?php echo $form->error($model,'file_author'); ?>
	</div>
